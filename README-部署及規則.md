...
- 逆主判P2正常0，只有：
  - 主判健康＋仍有效P1順風＋P2＋Q3；或
  - 主判弱勢＋主判次結有效突破＋首次Retest P2＋Q3
  才可0.25。
- 包含轉換可順已確認方向；反向只限Transition層真正P1＋Q3。
- 雙轉換／橫行只做邊界。
...
同一網站Origin更新時，V1.20沿用原有Storage Key，設計上舊紀錄及圖片繼續保留。
